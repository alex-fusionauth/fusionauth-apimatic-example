...
import {
  ...
  linkedInApplicationConfigurationSchema,
} from './linkedInApplicationConfiguration';
import {
  ProviderLambdaConfiguration,
  providerLambdaConfigurationSchema,
} from './providerLambdaConfiguration';

export interface LinkedInIdentityProvider {
  buttonText?: string;
  clientId?: string;
  clientSecret?: string;
  scope?: string;
  data?: Record<string, unknown>;
  applicationConfiguration?: Record<string, LinkedInApplicationConfiguration>;
  debug?: boolean;
  id?: string;
...
export const linkedInIdentityProviderSchema: Schema<LinkedInIdentityProvider> = object(
  {
    ...
    applicationConfiguration: [
      'applicationConfiguration',
      optional(dict(lazy(() => linkedInApplicationConfigurationSchema))),
    ],
