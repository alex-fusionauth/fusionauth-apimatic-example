...
import {
  ...
  hYPRApplicationConfigurationSchema,
} from './hYPRApplicationConfiguration';
import {
...
export interface HYPRIdentityProvider {
...
export const hYPRIdentityProviderSchema: Schema<HYPRIdentityProvider> = object({
  relyingPartyApplicationId: ['relyingPartyApplicationId', optional(string())],
  relyingPartyURL: ['relyingPartyURL', optional(string())],
  data: ['data', optional(dict(unknown()))],
  applicationConfiguration: [
    'applicationConfiguration',
    optional(dict(lazy(() => hYPRApplicationConfigurationSchema))),
  ],
