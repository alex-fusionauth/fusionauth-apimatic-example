...
import {
  ...
  twitterApplicationConfigurationSchema,
} from './twitterApplicationConfiguration';

/** Twitter social login provider. */
export interface TwitterIdentityProvider {
  buttonText?: string;
  consumerKey?: string;
...
export const twitterIdentityProviderSchema: Schema<TwitterIdentityProvider> = object(
  {
    ...
    applicationConfiguration: [
      'applicationConfiguration',
      optional(dict(lazy(() => twitterApplicationConfigurationSchema))),
    ],
