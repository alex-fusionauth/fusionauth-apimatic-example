...
export interface EpicGamesApplicationConfiguration {
  buttonText?: string;
  clientId?: string;
  clientSecret?: string;
  scope?: string;
...
export const epicGamesApplicationConfigurationSchema: Schema<EpicGamesApplicationConfiguration> = object(
  {
