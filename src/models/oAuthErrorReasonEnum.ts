...
/**
 * Enum for OAuthErrorReasonEnum
 */
export enum OAuthErrorReasonEnum {
...
/**
 * Schema for OAuthErrorReasonEnum
 */
export const  oAuthErrorReasonEnumSchema: Schema<OAuthErrorReasonEnum> = stringEnum(OAuthErrorReasonEnum);
