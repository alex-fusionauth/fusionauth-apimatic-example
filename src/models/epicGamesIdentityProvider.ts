...
import {
  ...
  epicGamesApplicationConfigurationSchema,
} from './epicGamesApplicationConfiguration';
import {
...
export interface EpicGamesIdentityProvider {
  buttonText?: string;
  clientId?: string;
  clientSecret?: string;
  scope?: string;
  data?: Record<string, unknown>;
  applicationConfiguration?: Record<string, EpicGamesApplicationConfiguration>;
  debug?: boolean;
  id?: string;
...
export const epicGamesIdentityProviderSchema: Schema<EpicGamesIdentityProvider> = object(
  {
    ...
    applicationConfiguration: [
      'applicationConfiguration',
      optional(dict(lazy(() => epicGamesApplicationConfigurationSchema))),
    ],
