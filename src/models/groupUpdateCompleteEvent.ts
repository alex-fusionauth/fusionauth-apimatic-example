...
export interface GroupUpdateCompleteEvent {
  group?: Group;
  original?: Group;
...
export const groupUpdateCompleteEventSchema: Schema<GroupUpdateCompleteEvent> = object(
  {
    group: ['group', optional(lazy(() => groupSchema))],
    original: ['original', optional(lazy(() => groupSchema))],
