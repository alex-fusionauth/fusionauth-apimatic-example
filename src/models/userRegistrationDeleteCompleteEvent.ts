...
export interface UserRegistrationDeleteCompleteEvent {
...
export const userRegistrationDeleteCompleteEventSchema: Schema<UserRegistrationDeleteCompleteEvent> = object(
  {
