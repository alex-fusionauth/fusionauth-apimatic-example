...
export interface UserUpdateCompleteEvent {
...
export const userUpdateCompleteEventSchema: Schema<UserUpdateCompleteEvent> = object(
  {
    original: ['original', optional(lazy(() => userSchema))],
